...
export const workflowSteps: WorkflowStep[] = [
	...
	{
		id: "aggregate",
		title: "Compute graph-native control status",
		whatHappens:
...
export const graphPipelineStages: GraphPipelineStage[] = [
	{
		...
		table: "documents",
		whatStored:
			"Source file metadata, content hash, and ingestion metadata per upload.",
		whyItMatters:
	...
	},
	{
		...
		whatStored:
			"Overlapping content slices with char offsets and token counts.",
		whyItMatters:
	...
	},
	{
		...
		whatStored:
			"Atomic evidence claims, supporting text, confidence, and source locator.",
		whyItMatters:
	...
	},
	{
		...
		whatStored:
			"Edges from atom -> SCF control with mapping polarity and coverage strength.",
		whyItMatters:
	...
	},
	{
		...
		whatStored:
			"Computed status, gap type, summary, and supporting atom IDs per control.",
		whyItMatters:
...
export const graphDecisionRules: GraphDecisionRule[] = [
	...
	},
	{
		...
		status: "compliant",
		gapType: "covered_by_strong_or_moderate_evidence",
		explanation:
	...
	},
	{
		...
		status: "partial",
		gapType: "covered_by_weak_evidence",
		explanation:
...
export const glossaryTerms: GlossaryTerm[] = [
	...
	},
	{
		...
		plainDefinition:
			"A testable statement used to verify whether a control is actually satisfied.",
		graphletterDefinition:
	...
	},
	{
		...
		plainDefinition:
			"The expected method for checking whether an objective is met.",
		graphletterDefinition:
	...
	},
	{
		...
		term: "Evidence Request List (ERL) Artifact",
		plainDefinition:
	...
	},
	{
		...
		plainDefinition:
			"Standard assessment outcomes describing whether evidence meets an objective.",
		graphletterDefinition:
	...
	},
	{
		...
		graphletterDefinition:
			"Used to flag weaker conclusions even when a control appears to pass.",
	...
	},
	{
		...
		term: "Framework Mapping (SCF Normalization)",
		plainDefinition:
			"SCF acts as a common layer that maps controls to many external frameworks.",
		graphletterDefinition:
...
export const resultGuidance: ResultGuidance[] = [
	{
		...
		nextAction:
			"Keep evidence current and improve documentation quality if confidence is low.",
	},
	{
		status: "partial",
		meaning:
		...
		nextAction:
			"Address the missing objective elements and upload updated evidence.",
	},
	{
		status: "fail",
	...
	},
	{
		...
		nextAction:
			"Validate applicability assumptions and attach context for audit traceability.",
	},
];
