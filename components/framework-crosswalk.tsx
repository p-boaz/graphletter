...
export function FrameworkCrosswalk() {
	...
	const [crosswalkResults, setCrosswalkResults] = useState<
		FrameworkCrosswalk[]
	>([]);
		...
		<div className="space-y-6">
			<div>
				...
				<p className="text-slate-600">
					Find direct mappings between controls across different compliance
					frameworks
				</p>
			</div>
				...
				<CardContent className="space-y-4">
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
						<div className="space-y-2">
							...
							<Select
								...
								onValueChange={setSourceFramework}
							>
								<SelectTrigger>
						...
						<div className="space-y-2">
							...
							<Select
								...
								onValueChange={setTargetFramework}
							>
								<SelectTrigger>
					...
					<div className="space-y-2">
						<Label htmlFor="search-query">
							Optional: Search Focus (e.g., &quot;access control&quot;,
							&quot;audit logging&quot;)
						</Label>
						<Input
							id="search-query"
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							{sourceFramework && targetFramework && (
								<>
									Control mappings between {sourceFramework} and{" "}
									{targetFramework}
								</>
							)}
						</CardDescription>
						...
						{crosswalkResults.length > 0 ? (
											...
											<div className="flex-1 space-y-2">
												...
												<div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
													<div>
														...
														<p className="text-slate-600">
															Control: {mapping.source_control_id}
														</p>
													</div>
													<div>
														<p className="font-medium text-slate-700">
														...
														<p className="text-slate-600">
															Control: {mapping.target_control_id}
														</p>
													</div>
												</div>
											</div>
							...
							<div className="py-8 text-center">
								...
								<p className="mb-4 text-slate-600">
									No direct mappings were found between {sourceFramework} and{" "}
									{targetFramework}.
								</p>
								<div className="space-y-2 text-slate-500 text-sm">
									...
									<ul className="list-inside list-disc space-y-1">
										<li>
											The frameworks don&apos;t have established mappings yet
										</li>
										<li>The mapping data hasn&apos;t been imported</li>
										<li>Try a more general search query</li>
										<li>
											Consider using the Enhanced Control Mapping for
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Quick access to commonly requested crosswalks
					</CardDescription>
				</CardHeader>
				<CardContent>
