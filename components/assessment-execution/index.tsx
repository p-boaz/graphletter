...
export function AssessmentExecution({ controlId }: AssessmentExecutionProps) {
  ...
  const handleUpdateAssessment = async (assessmentId: string, updates: Partial<UserAssessment>) => {
    try {
  ...
  const filteredAssessments = assessments.filter((item) => {
    const matchesSearch =
      !searchTerm ||
      item.scf_control?.title?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    const matchesResult = resultFilter === "all" || item.assessment_result === resultFilter;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-bold text-2xl text-slate-900">Assessment Execution</h2>
          <p className="text-slate-600">
            Execute and manage control assessments using SCF assessment objectives
      ...
      {stats && (
        <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="mb-1 font-bold text-2xl text-green-700">{stats.compliance_rate}%</div>
            ...
            <div className="flex gap-2">
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="requires_remediation">Needs Remediation</SelectItem>
                </SelectContent>
              </Select>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage assessment execution and track progress</CardDescription>
        </CardHeader>
        <CardContent>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <h4 className="mb-2 font-semibold text-slate-900">
                          {assessment.scf_control?.title || assessment.scf_control_id}
                        </h4>
                        ...
                        {assessment.evidence && (
                          <div className="mb-3 flex items-center gap-1 text-slate-600 text-sm">
                            ...
                            <span>1 evidence file linked</span>
                          </div>
                        )}

                        {assessment.assessment_summary && (
                          <div className="mb-3 text-slate-600 text-sm">
                            <strong>Summary:</strong> {assessment.assessment_summary}
                          </div>
                        )}
                      </div>
