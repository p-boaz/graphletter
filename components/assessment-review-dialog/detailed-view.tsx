    ...
    <>
      <div className="rounded-lg bg-blue-50 border border-blue-200 p-3 mb-4">
        <p className="text-blue-800 text-sm">
          ...
          score: <span className="font-bold">{getOverallScore(result)}%</span>
        </p>
      </div>
            ...
            <Card key={assessment.id} className="border-2">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <CardTitle className="text-lg">{assessment.scf_control_id}</CardTitle>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {isLowConfidence && <Badge variant="destructive">Low confidence</Badge>}
                    <Badge
                      variant={assessment.overall_result === "pass" ? "default" : "destructive"}
                    >
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="bg-blue-50 rounded-md p-3 border border-blue-200">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-semibold text-sm text-blue-900">AI Assessment Summary</h4>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="rounded-lg border border-purple-200 bg-purple-50 p-3 text-sm text-purple-900 space-y-3">
                      <div className="bg-white/70 rounded-md p-2 border border-purple-300">
                        <div className="flex items-center gap-2 mb-2">
                          <Bot className="h-4 w-4 text-blue-600" />
                          <span className="font-semibold text-blue-900 text-xs">AI Assessment</span>
                        </div>
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant="outline" className="text-xs">
                            {Math.round(assessment.maturity_assessment.confidence * 100)}%
                            confidence
                          </Badge>
                        </div>
                        {typeof assessment.maturity_assessment.target_level === "number" && (
                          <div className="text-xs mt-1">
                            ...
                            {typeof assessment.maturity_assessment.target_met === "boolean" && (
                              <Badge
                                variant={
                        ...
                        <div className="mt-2">
                          <span className="font-semibold text-xs text-blue-900">AI Rationale:</span>
                ...
                {assessment.objective_results && assessment.objective_results.length > 0 && (
                  <div>
                    <h4 className="font-semibold text-sm mb-2">Detailed Objectives:</h4>
                    <div className="space-y-2">
                      {assessment.objective_results.map((objective, idx) => (
                        <div
                          key={objective.scf_ao_id || `objective-${assessment.id}-${idx}`}
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <Badge
                              variant={objective.result === "pass" ? "default" : "destructive"}
                              className="text-xs"
                            >
