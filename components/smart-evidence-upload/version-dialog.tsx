    ...
    <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h4 className="font-medium text-amber-900">Existing Evidence Found</h4>
          ...
          <div className="mt-2 rounded bg-amber-100 p-2 text-amber-700 text-xs">
            ...
            <div className="mt-1 text-amber-600">
              Uploaded: {new Date(existingEvidence.submitted_at).toISOString().split("T")[0]}
            </div>
          </div>

          <div className="mt-3 space-y-2">
            <p className="font-medium text-amber-900 text-sm">What would you like to do?</p>
            <div className="space-y-2">
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => onVersionActionChange(e.target.value as "replace")}
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => onVersionActionChange(e.target.value as "keep_both")}
                  className="text-amber-600"
                />
                <span className="text-amber-800 text-sm">Keep both versions (separate upload)</span>
              </label>
            </div>
          </div>
