...
test("analytics page is drill-down focused and avoids overview duplication", async ({
  ...
  try {
    ...
    await expect(page.getByTestId(selectors.dashboard.analyticsDomainCoverageCard)).toBeVisible();
    await expect(page.getByTestId(selectors.dashboard.analyticsDomainCoverageTable)).toBeVisible();
    await expect(page.getByTestId(selectors.dashboard.analyticsDomainCoverageTable)).toContainText(
    ...
    await expect(controlsWithEvidenceCard).toContainText("Controls with any evidence");
