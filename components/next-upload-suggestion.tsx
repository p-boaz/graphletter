...
export function NextUploadSuggestion({
	...
	const [impactSummary, setImpactSummary] =
		useState<FrameworkImpactSummary | null>(null);
	...
	return (
		<div className="space-y-3">
			...
			{impactSummary && impactSummary.total_frameworks_impacted > 0 && (
				<div className="rounded-lg bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-100 px-4 py-3">
						...
						<div className="mt-2 flex flex-wrap gap-1">
							{topFrameworks.map((fw, index) => (
								<Badge
									...
									variant="secondary"
									className="bg-indigo-100/80 text-indigo-700 text-[10px] px-1.5 py-0"
								>
							...
							{impactSummary.total_frameworks_impacted > 5 && (
								<Badge
									variant="secondary"
									className="bg-indigo-100/80 text-indigo-500 text-[10px] px-1.5 py-0"
								>
