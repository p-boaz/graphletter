...
export async function run_critical_path(page: Page, options: CriticalPathOptions): Promise<void> {
...
export async function take_snapshot(page: Page, testInfo: TestInfo, name: string): Promise<string> {
...
export function assert_no_browser_failures(report: BrowserObservationReport): void {
