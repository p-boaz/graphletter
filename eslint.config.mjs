...
const config = [
  ...
  ...nextTypescript,
  {
    ignores: ["scripts/**", "playwright/artifacts/**", "**/.claude/**"],
  },
  {
    rules: {
      ...
      "no-restricted-imports": [
        "error",
        {
          patterns: [
            {
              group: ["@/app/api/*"],
              message: "Components must not import from API routes directly.",
            },
          ],
        },
      ],
      ...
      "no-restricted-imports": [
        "error",
        {
          patterns: [
            {
              group: ["@/components/*"],
              message: "API routes must not import from components.",
            },
          ],
        },
      ],
