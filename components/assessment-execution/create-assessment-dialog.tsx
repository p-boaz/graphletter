...
export function CreateAssessmentDialog({ onStartAssessment }: CreateAssessmentDialogProps) {
      ...
      <DialogContent aria-describedby={undefined}>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="mt-1 text-slate-500 text-xs">Leave empty to assess the entire control</p>
          </div>
