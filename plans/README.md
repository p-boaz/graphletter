...
| --- | -------------------------------------------------- | ---------------------------------------------------- | -------- | ------ | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 001 | `task-2026-06-11-paginate-compliance-reads.md`     | Paginate compliance reads past 1000-row cap          | P1       | M      | —          | DONE (commit `aba8ad6` on `fix/paginate-compliance-reads`, executor-built, advisor-reviewed 2026-06-11; awaiting merge)                                   |
| 002 | `task-2026-06-11-sanitize-api-error-responses.md`  | Stop leaking internal error details in API responses | P1       | M      | —          | DONE (commits `a442fc3..a8b15f0` on `fix/sanitize-api-error-responses`, executor-built, advisor-reviewed w/ 2 revision rounds 2026-06-11; awaiting merge) |
| 003 | `task-2026-06-11-structured-logging-api-routes.md` | console.\* → createLogger in app/api + lib, enforced | P2       | M      | 002        | TODO                                                                                                                                                      |
