...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    const organization =
      typeof user.user_metadata?.organization === "string" ? user.user_metadata.organization : "";
    const timezone =
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8">
            ...
            <p className="ft-sans text-slate-600 text-xl max-w-3xl mx-auto">
              Manage your account preferences, security settings, and notification preferences to
              customize your Graphletter experience.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <Tabs defaultValue="profile" className="space-y-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-slate-600">iOS Safari • New York, NY</p>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              handleNotificationChange("assessmentComplete", checked)
                            }
                          />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            <Label className="text-base">Evidence Approval</Label>
                            <p className="text-sm text-slate-600">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              handleNotificationChange("evidenceApproval", checked)
                            }
                          />
                        </div>
              ...
              <TabsContent value="billing" className="space-y-6">
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-center justify-between p-6 bg-blue-50 rounded-lg">
                      <div>
                        ...
                        <p className="text-slate-600">$299/month • Billed annually</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center space-x-2">
                          <Check className="h-4 w-4 text-green-600" />
                          <span className="text-sm">50+ compliance frameworks</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Check className="h-4 w-4 text-green-600" />
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="ft-serif text-red-600">Danger Zone</CardTitle>
                    <CardDescription>
